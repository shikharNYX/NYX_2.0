...
const mockData = {
  ...
  cacTrends: Array(10).fill(null).map((_, i) => {
    const dates = [
      "Jan 5", "Jan 15", "Jan 25", "Feb 1", "Feb 10",
      "Jan 5", "Jan 15", "Jan 25", "Feb 1", "Feb 10"
    ];
    return {
      date: dates[i],
...
const MiniBar = ({ value, total }: { value: number; total: number }) => {
  ...
  return (
    <div className="flex items-center justify-end gap-3">
      ...
      <span className="text-xs text-purple-400 min-w-[45px]">{percentage.toFixed(1)}%</span>
    </div>
  );
};
      ...
      <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
        <CardContent className="p-4">
          <section className="space-y-6">
            ...
            <h2 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400 mb-4">
              Executive Summary
            </h2>
            <div className="grid gap-4 md:grid-cols-3">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      <p className="text-sm font-medium text-purple-300">Total Customers</p>
                      <p className="text-xs text-purple-400">Active customer base</p>
                    </div>
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      <p className="text-sm font-medium text-purple-300">New Customers</p>
                      <p className="text-xs text-purple-400">Total new customer acquisitions</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="text-right">
                        <div className="flex items-center gap-1">
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    <div className="flex-1">
                      <p className="text-sm font-medium text-purple-300">Repeat Customers</p>
                      <p className="text-xs text-purple-400">Returning customer count</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="text-right">
                        <div className="flex items-center gap-1">
          ...
          <div className="mt-6">
            <div className="grid gap-4 md:grid-cols-2">
              {/* Customer Split Card */}
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20 h-[420px]">
                <CardHeader>
                  <CardTitle className="text-sm font-medium text-purple-300">Customer Split</CardTitle>
                  <p className="text-xs text-purple-400">Distribution of new vs repeat customers</p>
                </CardHeader>
                <CardContent>
                    ...
                    <ResponsiveContainer width="85%" height="100%">
                      <PieChart>
                        ...
                        <Tooltip
                          ...
                          formatter={(value: number) => [`${((value / mockData.customerMetrics.totalCustomers) * 100).toFixed(1)}%`, '']}
                        />
                        <Legend
                              ...
                              {payload?.map((entry: any) => (
                                <div key={entry.value} className="flex items-center gap-2">
                                  <div 
                                    ...
                                    style={{ 
                                      background: entry.payload.name === "New Customers" 
                                  ...
                                  <span className="text-sm text-purple-300/60">
                                    ({((entry.payload.value / mockData.customerMetrics.totalCustomers) * 100).toFixed(1)}%)
                                  </span>
                                </div>
                              ))}
                            </div>
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20 h-[420px]">
                <CardHeader>
                  <CardTitle className="text-sm font-medium text-purple-300">Customer Distribution</CardTitle>
                  <p className="text-xs text-purple-400">Breakdown by customer segments and growth</p>
                </CardHeader>
                <CardContent className="p-4">
                  <Table>
                    <TableHeader>
                      <TableRow className="border-b border-[#6D28D9]/20">
                        <TableHead className="text-purple-300 w-[220px]">
                          <Select
                            value={selectedSegment}
                            onValueChange={setSelectedSegment}
                          >
                            <SelectTrigger className="w-full bg-[#1A0B2E] border-[#6D28D9]/20 text-purple-300 h-8">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent className="bg-[#1A0B2E] border-[#6D28D9]/20">
                              {mockData.customerDistribution.segments.map(segment => (
                                <SelectItem key={segment.value} value={segment.value}>{segment.name}</SelectItem>
                              ))}
                            </SelectContent>
                          </Select>
                        </TableHead>
                        <TableHead className="text-purple-300 text-right w-[140px]">Distribution</TableHead>
                        <TableHead className="text-purple-300 text-right">Growth</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {segmentData.map((item, index) => (
                        ...
                        >
                          <TableCell className="text-purple-300">{item.category}</TableCell>
                          <TableCell className="text-purple-300">
                            <MiniBar value={item.distribution} total={totalDistribution} />
                          </TableCell>
          ...
          <div className="mt-6">
            ...
            <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20 mb-6">
              <CardHeader>
                <CardTitle className="text-sm font-medium text-purple-300">Cohort Retention Analysis</CardTitle>
                <p className="text-xs text-purple-400">User retention analysis by cohort and month</p>
              </CardHeader>
              <CardContent className="p-4">
                <div style={{ width: '100%', overflowX: 'auto' }}>
                  <div style={{ minWidth: '900px' }}>
                    <Table>
                      <TableHeader>
                        <TableRow className="border-b border-[#6D28D9]/20">
                          <TableHead className="text-purple-300 min-w-[120px] sticky left-0 bg-[#1A0B2E] z-10">Cohort</TableHead>
                          <TableHead className="text-purple-300 text-right min-w-[80px] sticky left-[120px] bg-[#1A0B2E] z-10">New</TableHead>
                          <TableHead className="text-purple-300 text-right min-w-[80px] sticky left-[200px] bg-[#1A0B2E] z-10">Spend</TableHead>
                          <TableHead className="text-purple-300 text-right min-w-[80px] sticky left-[280px] bg-[#1A0B2E] z-10">Rev</TableHead>
                          <TableHead className="text-purple-300 text-right min-w-[80px] sticky left-[360px] bg-[#1A0B2E] z-10">CAC</TableHead>
                          {[1, 2, 3, 4, 5, 6].map(month => (
                            <TableHead key={month} className="text-purple-300 text-right min-w-[80px]">
                              M{month}
                            </TableHead>
                          ))}
                        </TableRow>
                      ...
                      <TableBody>
                        <TableRow className="border-b border-[#6D28D9]/20 hover:bg-[#6D28D9]/5">
                          <TableCell className="text-purple-300 font-medium sticky left-0 bg-[#1A0B2E] z-10">{mockData.retentionData.averageRetention.cohort}</TableCell>
                          <TableCell className="text-purple-300 text-right sticky left-[120px] bg-[#1A0B2E] z-10">-</TableCell>
                          <TableCell className="text-purple-300 text-right sticky left-[200px] bg-[#1A0B2E] z-10">-</TableCell>
                          <TableCell className="text-purple-300 text-right sticky left-[280px] bg-[#1A0B2E] z-10">-</TableCell>
                          <TableCell className="text-purple-300 text-right sticky left-[360px] bg-[#1A0B2E] z-10">-</TableCell>
                          {mockData.retentionData.averageRetention.days.map((value, index) => (
                            <TableCell 
                              key={index} 
                              className={`text-right relative ${getRetentionColor(value)}`}
                            >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-purple-300">Repeat Purchase Behavior</CardTitle>
                  <p className="text-xs text-purple-400">Customer purchase frequency and retention analysis</p>
                </CardHeader>
                <CardContent className="p-4">
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardHeader>
                  <CardTitle className="text-sm font-medium text-purple-300">Customer Churn Rate</CardTitle>
                  <p className="text-xs text-purple-400">Monthly customer churn analysis</p>
                </CardHeader>
                <CardContent>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <Tooltip
                          ...
                          labelStyle={{ color: "#E9D5FF", fontWeight: 500, marginBottom: "4px" }}
                          itemStyle={{ color: "#E9D5FF", padding: "2px 0" }}
                        ...
                        <Line
                          ...
                          stroke="#6D28D9"
                          strokeWidth={2}
                          dot={{ fill: "#1A0B2E", stroke: "#6D28D9", strokeWidth: 2, r: 4 }}
                          activeDot={{
                            r: 6,
                            fill: "#E9D5FF",
                            stroke: "#6D28D9",
          ...
          <div className="mt-8">
            <h2 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400 mb-6">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-purple-300">Product Performance by Customer Segment</CardTitle>
                  <p className="text-xs text-purple-400">Top selling categories across different customer groups</p>
                </CardHeader>
                <CardContent className="p-4">
                  <div className="h-[320px]">
                    <ResponsiveContainer width="100%" height="100%">
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardHeader>
                  <CardTitle className="text-sm font-medium text-purple-300">Average Cart Size by Segment</CardTitle>
                  <p className="text-xs text-purple-400">Cart value and items per order across customer segments</p>
                </CardHeader>
                <CardContent>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                ...
                <CardContent className="p-2">
                  <div className="flex items-center justify-between h-[64px]">
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium text-purple-300">Customer Lifetime Value</p>
                      <p className="text-xs text-purple-400">(CLV)</p>
                    </div>
                    <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400">${mockData.customerFinancialMetrics.clv.current}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardContent className="p-2">
                  <div className="flex items-center justify-between h-[64px]">
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium text-purple-300">Customer Acquisition Cost</p>
                      <p className="text-xs text-purple-400">(CAC)</p>
                    </div>
                    <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400">${mockData.customerFinancialMetrics.cac.current}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardContent className="p-2">
                  <div className="flex items-center justify-between h-[64px]">
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium text-purple-300">Customer Retention Cost</p>
                      <p className="text-xs text-purple-400">(CRC)</p>
                    </div>
                    <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400">${mockData.customerFinancialMetrics.crc.current}</span>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
                <CardContent className="p-2">
                  <div className="flex items-center justify-between h-[64px]">
                    <div className="flex flex-col space-y-1">
                      <p className="text-sm font-medium text-purple-300">CLV to CAC Ratio</p>
                      <p className="text-xs text-purple-400">(CLV:CAC)</p>
                    </div>
                    <span className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400">{mockData.customerFinancialMetrics.clvCacRatio.current}x</span>
                  </div>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
              <CardHeader>
                <h3 className="text-sm font-medium text-purple-300">Customer Acquisition Cost Trends</h3>
                <p className="text-xs text-purple-400">Monthly CAC analysis</p>
              </CardHeader>
              <CardContent className="p-4">
            ...
            <Card className="bg-[#1A0B2E]/80 border-[#6D28D9]/20">
              <CardHeader>
                <h3 className="text-sm font-medium text-purple-300">CAC by Channel</h3>
                <p className="text-xs text-purple-400">Distribution across acquisition channels</p>
              </CardHeader>
              <CardContent className="p-4">
                <div className="h-[280px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      <Pie
                        data={[
                          { name: "Organic", value: 30, fill: "url(#organicGradient)" },
                          { name: "Paid", value: 25, fill: "url(#paidGradient)" },
                          { name: "Email", value: 20, fill: "url(#socialGradient)" },
                          { name: "Social Media", value: 15, fill: "url(#socialGradient)" },
                          { name: "Referral", value: 10, fill: "url(#referralGradient)" }
                        ]}
                        cx="50%"
                        cy="45%"
                        innerRadius={77}
                            ...
                            {payload?.map((entry: any) => (
                              <div key={entry.value} className="flex items-center gap-2">
                                <div 
                                  className="w-3 h-3 rounded-full" 
                                  style={{ 
                                    background: entry.payload.name === "Organic" ? "linear-gradient(to bottom, #c084fc, #9333ea)" :
                                              entry.payload.name === "Paid" ? "linear-gradient(to bottom, #818cf8, #4f46e5)" :
                                              entry.payload.name === "Email" || entry.payload.name === "Social Media" ? "linear-gradient(to bottom, #f0abfc, #d946ef)" :
